<template>
  ...
  >
    <template #header>방송알림 등록</template>
    <template #contents>
      <div class="notify-register-wrap">
        <p class="goods-title"><span>방송 30분 전</span> 예정시간을 알려드립니다.</p>
        ...
        <ul class="bullet-list">
          ...
          <li>오후 8시~익일 오전 8시 사이의 심야/새벽 방송은 오후 8시에 미리 알려드립니다.</li>
        </ul>
      </div>
    </template>
    <template #bottom>
      <div>
        <button class="register-bt" type="button" @click="toastHandler('방송 알림이 등록되었습니다.', 2000, 'bottom')">
          등록
        </button>
      </div>
    </template>
