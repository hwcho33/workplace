    ...
    <div class="inner">
      <div class="option-info">
        ...
        <div class="count-wrap">
          <p class="count-text">수량을 선택해주세요. <span class="remaining">(10개 남음)</span></p>
          <SpinButton v-model="spinBtState.exValue1" name="spin-button-01" @onChange="_onChangeSpinBt" />
        </div>
        ...
        <div class="order-goods-info">
          ...
          <SpinButton v-model="spinBtState.exValue2" name="spin-button-02" @onChange="_onChangeSpinBt" />
        ...
        <div class="order-goods-info">
          ...
          <SpinButton v-model="spinBtState.exValue3" name="spin-button-03" @onChange="_onChangeSpinBt" />
          <button type="button" class="delete-btn">삭제</button>
        </div>
