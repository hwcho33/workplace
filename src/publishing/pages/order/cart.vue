      ...
      <template v-else>
        <div class="check-all-wrap">
          <div class="check-all-inner">
            ...
            <button type="button" class="delete-btn"><i class="icon"></i>선택삭제</button>
          </div>
        </div>
                ...
                <li class="order-goods-info singsing">
                  ...
                  <div class="goods-wrapper">
                    <div class="goods-wrap">
                      ...
                      <!-- [D]: 단일 상품(옵션X) ex> class="option-info-wrap [single-option] -->
                      <div class="option-info-wrap">
                        ...
                        <div class="btn-wrap">
                          ...
                          <SpinButton v-model="state.spin1" name="spin-button-wrap" />
                        </div>
                      </div>
                    ...
                    <div class="goods-wrap">
                      ...
                      <div class="option-info-wrap single-option">
                        <div class="btn-wrap">
                          <SpinButton v-model="state.spin2" name="spin-button-01" />
                        </div>
                      </div>
